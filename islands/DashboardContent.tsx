        ...
        <div class="max-w-6xl mx-auto">
          ...
          <div class="flex flex-col gap-4 mb-6">
            ...
            <div class="flex flex-wrap gap-2 w-full sm:w-auto">
              ...
              {activeTab === 'books' && (
                user.role === "teacher" ||
                (user.role === "delegate" && selectedTeacher && selectedTeacher.isPlaceholder) ||
          ...
          {activeTab === 'scan' && (
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-xl p-6 mb-6">
              {currentBook ? (
                ...
                <BarcodeScanner onBookFound={handleBookFound} initialMode="camera" />
              )}
            </div>
          )}
            ...
            {filteredBooks.map((book) => (
              ...
              >
                ...
                {book.thumbnail ? (
                  ...
                  <div class="w-full h-48 flex items-center justify-center bg-gray-100 dark:bg-gray-700 mb-3 rounded">
